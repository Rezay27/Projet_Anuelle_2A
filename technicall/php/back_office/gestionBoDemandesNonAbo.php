...
<main>
    ...
    <div class="divBO">
        <section  class="bloc1BO">
            ...
            <?php
            $demande = $bdd ->query ("SELECT id_demandes,id_membre,date_demande,heure,ville,code_postal,adresse,ref_devis,ref_facture, sum(prix_demande) as prix_demande FROM `demandes` where statut_demande = 0 AND type_demande='simple' AND point_demande is null GROUP BY ref_devis  ");
            ?>
