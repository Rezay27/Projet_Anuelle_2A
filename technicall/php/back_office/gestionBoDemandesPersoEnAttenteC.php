...
$perso = $bdd->query("select id_demandes from demandes where statut_demande = 0 AND id_intervenant_demande is null AND type_demande='perso' AND ref_devis is null and date_demande > now() ");
...
<main>
    ...
    <div class="divBO">
        <section class="bloc1BO">
            <h3> Demandes Personnalisé en attente de validation
           ...
           <option value='gestionBoDemandesPersoEnCours.php'>Demandes en cours</option>
            ...
            $demande = $bdd->query("SELECT  nom_demande,id_demandes,id_membre,date_demande,heure,ville,code_postal,adresse,ref_devis,ref_facture,statut_devis from demandes where statut_demande = 0 AND type_demande = 'perso'  AND id_intervenant_demande is null  and refuser = 0 and ref_devis is not null and statut_devis=0 and date_demande > now() group by ref_devis ");
