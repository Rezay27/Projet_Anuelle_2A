...
<main>
    ...
    <div class="divBO">
        <section class="bloc1BO">
            <h3> Demandes Personnalisé en cours
           ...
           <option value"">Choisir une page</option>
            ...
            $demande = $bdd->query("SELECT  nom_demande,id_demandes,id_membre,date_demande,heure,ville,code_postal,adresse,ref_devis,ref_facture,statut_devis from demandes where statut_demande = 0 AND type_demande = 'perso'  and refuser = 0 and  id_intervenant_demande is not null and ref_devis is not null and date_demande > now() group by ref_devis ");
