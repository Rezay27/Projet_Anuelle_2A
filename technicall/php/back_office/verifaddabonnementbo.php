...
if(isset($_POST['valider_abonnement_bo'])) {
    ...
    $nb_point = htmlspecialchars($_POST['nombreP_abonnement']);
    ...
    $insert_info = $bdd->prepare('insert into info_abonnement(description1,description2,description3,nb_point,type_abonnement) values(:description1,:description2,:description3,:nb_point,:type_abonnement)');
